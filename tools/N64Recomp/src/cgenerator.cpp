...
void N64Recomp::CGenerator::emit_cop0_cause_read(int reg) const {
    fmt::print(output_file, "{} = cop0_cause_read(ctx);\n", gpr_to_string(reg));
}

void N64Recomp::CGenerator::emit_cop0_cause_write(int reg) const {
    fmt::print(output_file, "cop0_cause_write(ctx, {});\n", gpr_to_string(reg));
}

void N64Recomp::CGenerator::emit_cop0_count_read(int reg) const {
    fmt::print(output_file, "{} = cop0_count_read(ctx);\n", gpr_to_string(reg));
}

void N64Recomp::CGenerator::emit_cop0_count_write(int reg) const {
    fmt::print(output_file, "cop0_count_write(ctx, {});\n", gpr_to_string(reg));
}

void N64Recomp::CGenerator::emit_cop0_compare_read(int reg) const {
    fmt::print(output_file, "{} = cop0_compare_read(ctx);\n", gpr_to_string(reg));
}

void N64Recomp::CGenerator::emit_cop0_compare_write(int reg) const {
    fmt::print(output_file, "cop0_compare_write(ctx, {});\n", gpr_to_string(reg));
}

void N64Recomp::CGenerator::emit_cop0_epc_read(int reg) const {
    fmt::print(output_file, "{} = cop0_epc_read(ctx);\n", gpr_to_string(reg));
}

void N64Recomp::CGenerator::emit_cop0_badvaddr_read(int reg) const {
    fmt::print(output_file, "{} = cop0_badvaddr_read(ctx);\n", gpr_to_string(reg));
}

void N64Recomp::CGenerator::emit_cop0_generic_read(int reg, int cop0_reg) const {
    fmt::print(output_file, "{} = 0; // mfc0 cop0 reg {}\n", gpr_to_string(reg), cop0_reg);
}
