...
void N64Recomp::LiveGenerator::emit_cop0_cause_read(int reg) const { (void)reg; }
void N64Recomp::LiveGenerator::emit_cop0_cause_write(int reg) const { (void)reg; }
void N64Recomp::LiveGenerator::emit_cop0_count_read(int reg) const { (void)reg; }
void N64Recomp::LiveGenerator::emit_cop0_count_write(int reg) const { (void)reg; }
void N64Recomp::LiveGenerator::emit_cop0_compare_read(int reg) const { (void)reg; }
void N64Recomp::LiveGenerator::emit_cop0_compare_write(int reg) const { (void)reg; }
void N64Recomp::LiveGenerator::emit_cop0_epc_read(int reg) const { (void)reg; }
void N64Recomp::LiveGenerator::emit_cop0_badvaddr_read(int reg) const { (void)reg; }
void N64Recomp::LiveGenerator::emit_cop0_generic_read(int reg, int cop0_reg) const { (void)reg; (void)cop0_reg; }
