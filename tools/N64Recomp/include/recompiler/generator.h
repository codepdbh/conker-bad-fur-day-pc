...
namespace N64Recomp {
    ...
    public:
        ...
        virtual void emit_cop0_cause_read(int reg) const = 0;
        virtual void emit_cop0_cause_write(int reg) const = 0;
        virtual void emit_cop0_count_read(int reg) const = 0;
        virtual void emit_cop0_count_write(int reg) const = 0;
        virtual void emit_cop0_compare_read(int reg) const = 0;
        virtual void emit_cop0_compare_write(int reg) const = 0;
        virtual void emit_cop0_epc_read(int reg) const = 0;
        virtual void emit_cop0_badvaddr_read(int reg) const = 0;
        virtual void emit_cop0_generic_read(int reg, int cop0_reg) const = 0;
    ...
    public:
        ...
        void emit_cop0_cause_read(int reg) const final;
        void emit_cop0_cause_write(int reg) const final;
        void emit_cop0_count_read(int reg) const final;
        void emit_cop0_count_write(int reg) const final;
        void emit_cop0_compare_read(int reg) const final;
        void emit_cop0_compare_write(int reg) const final;
        void emit_cop0_epc_read(int reg) const final;
        void emit_cop0_badvaddr_read(int reg) const final;
        void emit_cop0_generic_read(int reg, int cop0_reg) const final;
