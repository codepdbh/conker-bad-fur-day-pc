...
Note the visibility is unidirectional; if you want two segments to see each other, you need to add a `prioritized_segments` on both, listing each other's names.
